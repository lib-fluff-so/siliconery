...
public class SiliconeryToolRecipe implements CraftingRecipe {
    final Ingredient toolIngredient;
    final Ingredient inputIngredient;
    final ItemStackTemplate result;
    final int toolDamage;

    public SiliconeryToolRecipe(Ingredient toolIngredient, Ingredient inputIngredient, ItemStackTemplate result, int toolDamage) {
    ...
    public RecipeSerializer<? extends CraftingRecipe> getSerializer() {
        return SiliconeryRecipeSerializers.TOOL_RECIPE_SERIALIZER;
    }
