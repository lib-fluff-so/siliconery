...
public class SiliconeryRecipeSerializers {

    private static final MapCodec<SiliconeryToolRecipe> TOOL_CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(
            ...
            ).apply(instance, SiliconeryToolRecipe::new)
    );

    private static final StreamCodec<RegistryFriendlyByteBuf, SiliconeryToolRecipe> TOOL_STREAM_CODEC =
            StreamCodec.composite(
                    ...
                    SiliconeryToolRecipe::new
            );

    public static final RecipeSerializer<SiliconeryToolRecipe> TOOL_RECIPE_SERIALIZER =
            Registry.register(
