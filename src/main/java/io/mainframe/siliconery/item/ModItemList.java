...
public class ModItemList {
    ...
    public static final Item CASING_TEMPLATE = registerItem(ModItemIds.CASING_TEMPLATE, Item::new, new Item.Properties());
    public static final Item SCREW = registerItem(ModItemIds.SCREW, Item::new, new Item.Properties());
